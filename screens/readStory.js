...
export default class ReadStory extends React.Component {
  ...
  getRequestedStoriesList=()=>{
    this.requestRef = db.collection('stories').onSnapshot((snapshot)=>{
      var list = snapshot.docs.map((doc)=>{ doc.data() })
      this.setState({storiesList:list})
    })
        ...
        <View>
          {
            ...
            (
              <FlatList data={this.state.storiesList} renderItem={this.renderItem}  />
            )
          }
